import {
  ...
  FlaskConical, UserPlus, CalendarDays, ShieldCheck,
} from 'lucide-react';
...
const NAV = {
  ...
  committee: [
    ...
    { id: 'research',   label: 'Research Workspace', icon: FlaskConical    },
  ...
  committee_chair: [
    ...
    { id: 'cases',      label: 'Cases',             icon: ClipboardList   },
    { id: 'research',   label: 'Research Workspace', icon: FlaskConical    },
    { id: 'auditors',   label: 'Team Formation',     icon: Users           },
    { id: 'sessions',   label: 'Sessions',           icon: CalendarDays    },
    { id: 'audit-trail',label: 'Audit Trail',        icon: ShieldCheck     },
  ],
  senior_management: [
      ...
      <div className={`px-5 py-5 border-b ${logoBorder}`}>
        <div className="flex items-center gap-3">
          <img
            src="/mor-logo.jpeg"
            alt="MOR"
            className="w-10 h-10 rounded-full object-cover flex-shrink-0 shadow-lg border-2 border-slate-600"
            onError={e => { e.target.style.display='none'; e.target.nextSibling.style.display='flex'; }}
          />
          <div
            className="w-10 h-10 bg-gradient-to-br from-pink-500 via-purple-500 to-blue-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg"
            style={{ display: 'none' }}
          >
