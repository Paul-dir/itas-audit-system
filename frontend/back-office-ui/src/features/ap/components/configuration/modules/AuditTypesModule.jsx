...
function AuditTypesModule({ data, onUpdate }) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-card-dark border border-border-dark rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-text-hi mb-2">Effort Per Case (Hours)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-text-hi mb-2">Complexity</label>
              <select
                value={formData.complexity || ''}
                onChange={(e) => setFormData({ ...formData, complexity: e.target.value })}
                className="w-full px-4 py-2 bg-neutral-900 border border-border-dark rounded-lg text-text-hi focus:outline-none focus:border-blue focus:ring-2 focus:ring-blue focus:ring-opacity-20"
              >
            ...
            <div>
              <label className="block text-sm font-semibold text-text-hi mb-2">Description</label>
              <textarea
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-text-hi">Audit Types ({data.length})</h2>
        <button
          ...
          <div key={item.id} className="bg-card-dark border border-border-dark rounded-lg p-4 flex justify-between items-center hover:border-blue transition-colors">
            <div>
              ...
              <p className="text-sm text-text-mid">
                Effort: {item.effortPerCase}h • Complexity: {item.complexity}
              </p>
            </div>
...
export default AuditTypesModule;
