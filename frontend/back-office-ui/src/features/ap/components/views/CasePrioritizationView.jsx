...
function CasePrioritizationView() {
  ...
  const handleStoreSelectedCases = () => {
    ...
    const currentPlan = (data.plans || []).find(p => p.status === 'APPROVED' || p.status === 'SUBMITTED_TO_DIRECTOR');
    ...
    const message = skipped > 0 
      ...
      : `✅ Successfully prioritized and stored ${count} cases for Plan Year ${planYear}.`;
