...
CREATE TABLE IF NOT EXISTS tp_risk_assessment (
    id UUID PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_tp_risk_assessment_case ON tp_risk_assessment(audit_case_id);

-- 2. TP Working Hypothesis
CREATE TABLE IF NOT EXISTS tp_working_hypothesis (
    id UUID PRIMARY KEY,
    audit_case_id UUID NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_tp_working_hypothesis_case ON tp_working_hypothesis(audit_case_id);

-- 3. TP Audit Plan
CREATE TABLE IF NOT EXISTS tp_audit_plan (
    id UUID PRIMARY KEY,
    audit_case_id UUID NOT NULL,
    objective TEXT,
    scope TEXT,
...
CREATE INDEX IF NOT EXISTS idx_tp_audit_plan_case ON tp_audit_plan(audit_case_id);
